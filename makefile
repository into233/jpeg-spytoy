...
reader.o: reader.c reader.h jpegerror.o spywriter.o
	$(cc) $(cflag) -c reader.c
...
main: decoder.o reader.o jpegerror.o parse_metafile.o spywriter.o
	$(cc) $(cflag) -o main  parse_metafile.o reader.o decoder.o jpegerror.o spywriter.o
